export default {
  ...
  createSurveyErrDuplicateTitle: 'Unable to create survey. The survey folder {folderName} already exists in the account.',
  ...
  editSurveyBtnDisabledTip1: 'You do not have permission to perform this action. Required privileges: "admin" or "update" control to both form and source feature layer items.',
